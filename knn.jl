...
function knn(k::Int)
    ...
    println("Resultados en promedio al separar todas las clases con K=", k,  ":")
    ...
    return Dict("mean_train" => mean(precisionesEntrenamiento), "std_train" => std(precisionesEntrenamiento),
                "mean_test" => mean(precisionesTest), "std_test" => std(precisionesTest), "k" => k);
